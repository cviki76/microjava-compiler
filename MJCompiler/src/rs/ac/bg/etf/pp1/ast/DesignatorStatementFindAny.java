...
public class DesignatorStatementFindAny extends DesignatorStatement {
    ...
    public DesignatorStatementFindAny (Designator Designator, Designator Designator1, FindAnyBegin FindAnyBegin, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatementFindAny(\n");
