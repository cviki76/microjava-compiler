...
public class ConstIdentMoreThanOne extends ConstIdentList {

    private ConstIdentList ConstIdentList;
    private ConstIdent ConstIdent;

    public ConstIdentMoreThanOne (ConstIdentList ConstIdentList, ConstIdent ConstIdent) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstIdentMoreThanOne(\n");
